...
// 15 tests for s21_abs
START_TEST(s21_absTEST) {
  ck_assert_int_eq(s21_abs(-1. / 0.), abs(-1. / 0.));
  ck_assert_int_eq(s21_abs(1. / 0.), abs(1. / 0.));
  ck_assert_int_eq(s21_abs(0. / 0.), abs(0. / 0.));
  ck_assert_int_eq(s21_abs(-1), abs(-1));
  ck_assert_int_eq(s21_abs(0.0), abs(0.0));
  ck_assert_int_eq(s21_abs(-0xA13), abs(-0xA13));
  ck_assert_int_eq(s21_abs(-867568468), abs(-867568468));
  ck_assert_int_eq(s21_abs(-0.000005), abs(-0.000005));
  ck_assert_int_eq(s21_abs(-1 / 3), abs(-1 / 3));
  ck_assert_int_eq(s21_abs(1 / 3), abs(1 / 3));
  ck_assert_int_eq(s21_abs(7652), abs(7652));
  ck_assert_int_eq(s21_abs(-1.00005), abs(-1.00005));
  ck_assert_int_eq(s21_abs(-123456.5555), abs(-123456.5555));
...
START_TEST(s21_ceilTEST) {
  int tests[17] = {1.1,      10.98,     123.123,    3.33,        15.5,   16.5,
                   -1.1,     -10.98,    -123.123,   -3.33,       -15.5,  -16.5,
                   123456.5, 123456.55, 123456.555, 123456.5555, 1.00005};
  for (int i = 0; i < 17; i++) {
    ck_assert_ldouble_eq_tol(s21_ceil(tests[i]), ceil(tests[i]), 1e-6);
  }
  long double a1 = s21_ceil(0.0 / 0.0);
  long double a2 = ceil(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
  ck_assert_ldouble_nan(s21_ceil(0.0 / 0.0));
  ck_assert_msg(s21_ceil(-1. / 0.) == ceil(-1. / 0.), "test failed.");
  ck_assert_msg(s21_ceil(1. / 0.) == ceil(1. / 0.), "test failed.");
  ck_assert_ldouble_eq_tol(s21_ceil(-0.456), ceil(-0.456), 1e-6);
...
START_TEST(s21_floorTEST) {  // 54 tests
  ck_assert_msg(s21_floor(-1. / 0.) == floor(-1. / 0.), "test failed.");
  ck_assert_msg(s21_floor(1. / 0.) == floor(1. / 0.), "test failed.");
  long double a1 = s21_floor(0.0 / 0.0);
  long double a2 = floor(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
...
START_TEST(s21_fabsTEST) {
  ck_assert_msg(s21_fabs(-1. / 0.) == fabs(-1. / 0.), "test failed.");
  long double a1 = s21_fabs(0.0 / 0.0);
  long double a2 = fabs(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
...
START_TEST(s21_fmodTEST) {
  ck_assert_ldouble_eq_tol(s21_fmod(0.543, 1. / 0.), fmod(0.543, 1. / 0.),
                           1e-6);
...
START_TEST(s21_expTEST) {
  ck_assert_msg(s21_exp(-1. / 0.) == exp(-1. / 0.), "test failed.");
  ck_assert_msg(s21_exp(1. / 0.) == exp(1. / 0.), "test failed.");
  long double a1 = s21_exp(0.0 / 0.0);
  long double a2 = exp(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
...
START_TEST(s21_cosTEST) {
  long double a1 = s21_cos(0.0 / 0.0);
  long double a2 = cos(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
...
START_TEST(s21_sinTEST) {
  long double a1 = s21_sin(0.0 / 0.0);
  long double a2 = sin(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
...
START_TEST(s21_tanTEST) {
  long double a1 = s21_tan(0.0 / 0.0);
  long double a2 = tan(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
  ck_assert_int_eq(a1, a2);
...
START_TEST(s21_logTEST) {
  ck_assert_msg(s21_log(1. / 0.) == log(1. / 0.), "test failed.");
  long double a1 = s21_log(0.0 / 0.0);
  long double a2 = log(0.0 / 0.0);
  if (a1 == s21_NAN) a1 = 1;
  if (a2 == s21_NAN) a2 = 1;
